...
export default function SetBoard({
  ...
  return (
    <div className="mx-auto w-[90dvw]">
      <div className="grid gap-2 portrait:w-[min(90dvw,50rem)] portrait:grid-cols-3 landscape:w-[min(90dvw,50rem)] landscape:grid-flow-col landscape:grid-rows-3">
